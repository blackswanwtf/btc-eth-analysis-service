 ...
 * Handles loading, versioning, and templating of analysis prompts
 */
...
class PromptManager {
   ...
   * @param {string} promptName - Name of the prompt (e.g., 'performance-trend')
   * @param {string} version - Version (e.g., 'v1', 'v2')
   * @returns {string} Raw prompt template
   */
  loadPromptTemplate(promptName = "performance-trend", version = null) {
   ...
   */
  getAvailableVersions(promptName = "performance-trend") {
    try {
